            ...
            <div className="flex flex-wrap items-center gap-2">
              {categories.map(cat => (
                <button
                  ...
                  className={`ftab rounded-lg border border-[var(--border)] px-4 py-2 text-xs font-medium cursor-pointer transition-all ${
                    activeCat === cat ? "bg-[var(--blue)] text-white border-[var(--blue)]" : "text-[var(--text2)] hover:border-[var(--blue)]"
                  }`}
                >
                    ...
                    <div className="card-body p-5 flex-1 flex flex-col justify-between">
                      <div>
                        <div className="card-top flex items-start justify-between gap-2 mb-2">
                          <div>
                            <div className="card-cat text-[10px] uppercase font-bold tracking-wider text-[var(--text3)]">
                              {p.cat}
                            </div>
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm overflow-y-auto">
            ...
            >
              ...
              <div className="p-6 md:p-8 overflow-y-auto flex-1">
                <div className="modal-cat text-[10px] uppercase font-bold tracking-wider text-[var(--text3)] mb-1">
                  {selectedProduct.cat}
                </div>
